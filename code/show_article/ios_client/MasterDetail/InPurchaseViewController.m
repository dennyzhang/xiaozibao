...
@interface InPurchaseViewController () {
      NSArray *_products;
...
- (void)reload {
    ...
    [[CQIAPHelper sharedInstance] requestProductsWithCompletionHandler:^(BOOL success, NSArray *products) {
        if (success) {
            _products = products;
            [self.tableView reloadData];
        }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([[CQIAPHelper sharedInstance] productPurchased:product.productIdentifier]) {
...
- (void)buyButtonTapped:(id)sender {
    ...
    [[CQIAPHelper sharedInstance] buyProduct:product];
