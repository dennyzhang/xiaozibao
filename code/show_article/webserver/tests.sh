...
## --
## Created : <2014-01-11>
## Updated: Time-stamp: <2014-03-16 13:48:19>
##-------------------------------------------------------------------
. $XZB_HOME/cmd/utility.sh

request_url_get "http://127.0.0.1:9180/api_list_topic?topic=idea_startup&start_num=0&count=10" -I
request_url_get "http://127.0.0.1:9180/api_get_post?id=603b7839ca91880485b9895789291e25" -I
request_url_get "http://127.0.0.1:9180/api_list_topic?topic=idea_startup&start_num=0&count=10&voteup=0" -I
