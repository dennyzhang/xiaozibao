...
## --
## Created : <2014-01-11>
## Updated: Time-stamp: <2014-02-15 00:34:32>
##-------------------------------------------------------------------
...
request_url_post http://127.0.0.1:9080/api_feedback_post "uid=denny&postid=0fa410a29c294cf498c768b0cebc99c0&comment=somecomment"
## File : tests.sh ends
